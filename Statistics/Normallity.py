...
The `chk_norm` function checks whether the residuals from a linear regression model follow a normal distribution.
It performs the Jarque-Bera test for normality and evaluates the skewness and kurtosis against specified thresholds.
The function returns whether the residuals are likely normal, along with the Jarque-Bera test statistic, p-value, skewness,
and kurtosis. Optionally, it can print a conclusion based on these tests.
"""
